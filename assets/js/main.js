...
(function () {
  ...
  /* ── Config ────────────────────────────────────────────── */
  const WA_NUMBER = '554633135040';
  const WA_MESSAGE = encodeURIComponent(
    'Olá! Vim pela página de Palmas e quero contratar a internet da Palmasnet. Pode me ajudar?'
  );
  const WA_BASE = `https://wa.me/${WA_NUMBER}?text=${WA_MESSAGE}`;

  /* ── Webhook Make ───────────────────────────────────────── */
  var WEBHOOK_URL = 'https://hook.us2.make.com/fj2lx53db3md5gxipru2r7h4zulpkk6s';
